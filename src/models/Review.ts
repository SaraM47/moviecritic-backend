...
export interface ReviewDoc {
  ...
  title: string; // Short title summarizing the review
...
const reviewSchema = new Schema<ReviewDoc>(
  {
    ...
    title: { type: String, required: true, minlength: 2, maxlength: 100, trim: true,
    },

    rating: { type: Number, required: true, min: 1, max: 10 },

    text: { type: String, required: true, minlength: 2, maxlength: 2000, trim: true,
    },
  },
  { timestamps: true }
);
